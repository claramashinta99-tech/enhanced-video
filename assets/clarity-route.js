...
.upload-guide-action{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-top:18px;padding-top:16px;border-top:2px dashed #35446a}.upload-guide-action small{color:#7f8caf;line-height:1.55;max-width:760px}.upload-guide-action .btn{white-space:nowrap}#open-tiktok-studio{background:linear-gradient(135deg,#11182b,#171f39 58%,#1b1636)!important;border-color:#6e7fb5!important;color:#f7f9ff!important;box-shadow:0 8px 22px rgba(0,0,0,.28),0 0 18px rgba(110,216,255,.08)!important}#open-tiktok-studio:hover{background:linear-gradient(135deg,#151f36,#1c2747 58%,#241b46)!important;border-color:#8da0da!important}#open-tiktok-studio .guide-key{background:linear-gradient(90deg,#dff7ff,#9edcff,#c7adff)!important;background-size:180% 100%!important;-webkit-background-clip:text!important;background-clip:text!important;color:transparent!important;filter:drop-shadow(0 0 5px rgba(110,216,255,.2))!important;text-shadow:none!important;animation:guideKeyFlow 3.2s linear infinite!important}#open-tiktok-studio .guide-key:after{background:linear-gradient(90deg,transparent,#6ed8ff,transparent)!important;box-shadow:0 0 8px rgba(110,216,255,.38)!important}
