(()=>{
  ...
  const copy={
    id:{
      ...
      primary:'Buka Universal Downloader',secondary:'TikTok Method',active:'10 tools aktif',quick:'Quick access',quickState:'10 / 10 AKTIF',universalOpen:'Buka',universalSub:'Tempel link yang didukung. RVL otomatis deteksi platform.',universalBest:'Kualitas terbaik',universalAuto:'● Deteksi platform otomatis',universalDevice:'● Desktop + mobile',
    ...
    en:{
      ...
      primary:'Open Universal Downloader',secondary:'TikTok Method',active:'10 tools live',quick:'Quick access',quickState:'10 / 10 LIVE',universalOpen:'Open',universalSub:'Paste any supported link. RVL detects the platform automatically.',universalBest:'Best quality',universalAuto:'● Auto detect platform',universalDevice:'● Desktop + mobile',miniClarity:'Cleaner / HD TikTok upload prep',miniTikTok:'Video download',miniYouTube:'Video up to 4K',miniShorts:'Shorts downloader',miniMp3:'Audio convert · 192 kbps',miniFacebook:'Public video downloader',miniInstagram:'Public Reel / video',miniX:'Public video downloader',
  ...
  function apply(){const dict=copy[lang()]||copy.id;document.querySelectorAll('[data-home-i18n]').forEach(el=>{const key=el.dataset.homeI18n;if(dict[key])el.textContent=dict[key]});const input=document.querySelector('#home-universal-url');if(input)input.placeholder=lang()==='en'?'Paste your link here...':'Tempel link di sini...';bindUniversal()}
