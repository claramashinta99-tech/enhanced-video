...
COPY backend/app.py backend/mp3_app.py backend/audio_chunked_app.py backend/diagnostic_app.py backend/shorts_app.py backend/youtube_engine_app.py backend/tiktok_engine_app.py backend/tiktok_hd_app.py backend/social_downloaders_app.py backend/media_inspector_app.py backend/carousel_routes.py ./
